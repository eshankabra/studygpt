...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen pt-32 pb-20 px-6 flex items-center justify-center">
            ...
            >
                <div className="absolute top-0 left-0 -z-10 w-full h-full bg-blue-500/5 blur-3xl" />
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full primary-button py-3.5 rounded-xl text-white font-bold transition-all text-sm mt-6"
                    >
                        Sign Up
                    </button>
                </form>
                ...
                <div className="my-6 flex items-center gap-4">
                    ...
                    <span className="text-xs text-slate-500 uppercase font-semibold">Or register with</span>
                    <div className="flex-1 border-b border-white/10" />
                </div>
